...
//     beforeEach(function () {
//         serverNameInput.value = 'Jules';
//         billAmtInput.value = 23;
//         tipAmtInput.value = 5;
    //});
    
    // it('should test if functions within this function are being called', function () {
    //     let tableSpy1 = updateServerTable();
    //     submitPaymentInfo(new Event('submit'));
    //     expect(tableSpy1).toHaveBeenCalled();
    // });
